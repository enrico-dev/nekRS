...
ins_t *insSetup(MPI_Comm comm, setupAide &options, int buildOnly)
{
  ...
  const string bcDataFile = "/Users/ronald/repos/nekRS/src/insBcData.h";
  ...
  const string oklpath = "/Users/ronald/repos/nekRS/okl/core/";
  ...
  for (int r=0;r<2;r++){
    if ((r==0 && mesh->rank==0) || (r==1 && mesh->rank>0)) {
      ...
      fileName = "/Users/ronald/repos/nekRS/3rd_party/libparanumal/okl/scaledAdd.okl";
      kernelName = "scaledAddwOffset";
      ins->scaledAddKernel = 
        mesh->device.buildKernel(fileName.c_str(), kernelName.c_str(), kernelInfo);

      fileName = "/Users/ronald/repos/nekRS/3rd_party/libparanumal/okl/addScalar.okl";
